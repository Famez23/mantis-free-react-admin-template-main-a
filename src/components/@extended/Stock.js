...
export default function Stock() {
  ...
  function handleChangee(event) {
    ...
    try {
      ...
      {stockLabel:postType.stockLabel,
      });
  ...
  return (
    <div>
      ...
      {open && (<Dialog open={open} onClose={handleClose}>
          ...
          <DialogTitle>Nouvelle type de stock</DialogTitle>
            <DialogContent>
              <form onSubmit={handleSubmit}>
              <FormControl sx={{ m: 1, minWidth: 120 }}>
                <TextField name="stockLabel" label="libellé de stock" variant="outlined" value={postType.stockLabel}  onChange={handleChangee} />
              </FormControl>
            <DialogActions> 
